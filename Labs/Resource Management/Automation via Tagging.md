...
* **Project:** Identifies the workload (`ERPSystem` or `Experiment1`).
...
* **Query and filter resources** dynamically based on specific tag values using advanced CLI parameters.
