...
During this lab, I deployed and managed a DynamoDB table specifically configured to store and retrieve information for a mock **music library**. I gained practical, job-ready competencies across the entire database lifecycle, spanning creation, data entry, querying, and deletion.
