...
* **Environment Validation:** I deployed and tested the permissions in a live AWS Management Console. I have logged in as a support-engineer-1 user and I tried to terminate the EC2 Instance. That action failed, as this user did not have the permission to terminate the instance.
